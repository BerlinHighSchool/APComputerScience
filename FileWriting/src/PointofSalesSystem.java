...
public class PointofSalesSystem
{
	...
	public PointofSalesSystem()
	{
		...
		lblLifeOfPie.setBounds(204, 19, 421, 23);
		...
		lblMenuOptions.setBounds(634, 78, 122, 37);
		...
		btnOption1.setBounds(634, 274, 166, 57);
		Main.add(btnOption1);
		...
		btnOption2.setBounds(634, 342, 166, 57);
		Main.add(btnOption2);
		...
		btnOption3.setBounds(634, 410, 166, 57);
		Main.add(btnOption3);
		...
		btnNewOrder.setBounds(385, 363, 147, 53);
		...
		btnViewOrderHistory.setBounds(385, 112, 147, 53);
		...
		btnPlaceOrder.setBounds(465, 420, 116, 53);
		...
		btnCancelOrder.setBounds(337, 420, 116, 53);
		...
		dtrpnTotal.setContentType("text/html");
		dtrpnTotal.setText("Total:<b>"+ "<center>" + formatter.format(total)+ "</center>");
		dtrpnTotal.setBorder(BorderFactory.createLineBorder(Color.black));
		dtrpnTotal.setBounds(10, 501, 280, 46);
		Main.add(dtrpnTotal);
		JLabel lblAlternateViews = new JLabel("Alternate Views:");
		lblAlternateViews.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblAlternateViews.setBounds(385, 84, 154, 25);
		Main.add(lblAlternateViews);
		scrollPane_1.setBounds(10, 78, 280, 331);
		...
		lblPreviousOrders.setBounds(44, 220, 119, 27);
		...
		displayOrder.setBounds(44, 284, 147, 27);
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if(e.getSource()==btnPlaceOrder)
			{
				...
				if(customerName!=null)
				{
					...
					{
						JOptionPane.showMessageDialog(new JFrame(), "Enter the customer's name.", "Dialog",
